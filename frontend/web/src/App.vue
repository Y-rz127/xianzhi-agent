<template>
  <div class="layout">
    ...
    <aside class="sidebar" :class="{ 'open': sidebarOpen, 'collapsed': sidebarCollapsed }" :style="{ width: sidebarWidth + 'px' }">
      ...
      <router-link to="/admin-accounts" class="nav-item" active-class="active" @click="onNavClick">
        <span class="nav-icon account-icon">
        ...
        <span v-if="!sidebarCollapsed">账号管理</span>
      </router-link>
        ...
        <router-link to="/answer-feedback" class="nav-item" active-class="active" @click="onNavClick">
          <span class="nav-icon">
          ...
          <span v-if="!sidebarCollapsed">回答反馈</span>
        </router-link>
      </nav>
