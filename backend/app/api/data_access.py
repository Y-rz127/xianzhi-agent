...
add_kline_event = _async(chart_store.add_kline_event)
add_kline_feedback = _async(chart_store.add_kline_feedback)
add_kline_pair_event = _async(chart_store.add_kline_pair_event)
delete_kline_event = _async(chart_store.delete_kline_event)
delete_kline_pair_event = _async(chart_store.delete_kline_pair_event)
...
kline_event_stats = _async(chart_store.kline_event_stats)
kline_feedback_stats = _async(chart_store.kline_feedback_stats)
kline_pair_event_stats = _async(chart_store.kline_pair_event_stats)
list_chart_profiles_by_user = _async(chart_store.list_chart_profiles_by_user)
list_kline_events = _async(chart_store.list_kline_events)
list_kline_feedback = _async(chart_store.list_kline_feedback)
list_kline_pair_events = _async(chart_store.list_kline_pair_events)
...
# ===== 收藏 / 通用 AI 解读记录 / 反馈 / 样本导出（app.db.user_records） =====
...
add_ai_interpretation_record = _async(user_records.add_ai_interpretation_record)
delete_answer_feedback = _async(user_records.delete_answer_feedback)
delete_feedback = _async(user_records.delete_feedback)
delete_ai_interpretation_record = _async(user_records.delete_ai_interpretation_record)
...
list_ai_interpretation_records = _async(user_records.list_ai_interpretation_records)
...
get_session_birth_info = _async(postgres_memory.get_session_birth_info)
upsert_session_birth_info = _async(postgres_memory.upsert_session_birth_info)
