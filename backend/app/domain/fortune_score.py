...
_DIM_EMPHASIS = {
    ...
    # 官杀为事业之本、印为权柄资历；财生官为权柄之源亦耗身，功过相抵近中性；
    # 比劫夺权，权重下调
    "career": {"比劫": 0.8, "印枭": 1.3, "食伤": 0.8, "财": 0.9, "官杀": 1.6},
    # 财为财源、食伤生财；比劫直接夺财（与学业财 0.6 的惩罚力度对称）、
    # 印夺食伤之源、官杀泄财之气，权重下调
    "wealth": {"比劫": 0.7, "印枭": 0.7, "食伤": 1.4, "财": 1.8, "官杀": 0.7},
    # 官杀攻身为病源之首（论病先看克身之神）；比劫同气主元气——身弱得之为药、
    # 身旺逢之过亢，双向敏感故居次；印为养护；财耗身
    "health": {"比劫": 1.3, "印枭": 1.2, "食伤": 1.1, "财": 0.8, "官杀": 1.4},
...
# 源星取妻/夫星的六五折：男食伤生财是感情经营与表达之路（食神生财，男命会哄肯付出），
# 女财生官是滋夫旺夫之路（财旺生官，夫荣妻贵）——源星给 1.1；不满财运维度的 1.4，
# 因"表达→姻缘"链路比"技能→收入"间接，且食伤多情、财耗身在承诺型维度是双刃。
# 印克食伤断情之源、又主长辈干涉，男女皆间接偏忌（0.9，略低于其所伤的源星）
_DIM_EMPHASIS_LOVE_MALE = {"比劫": 0.7, "印枭": 0.9, "食伤": 1.1, "财": 1.7, "官杀": 0.8}
_DIM_EMPHASIS_LOVE_FEMALE = {"比劫": 0.9, "印枭": 0.9, "食伤": 0.7, "财": 1.1, "官杀": 1.7}
