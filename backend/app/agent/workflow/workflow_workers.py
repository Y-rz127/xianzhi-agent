...
WORKERS: dict[str, DomainWorker] = {
    ...
    "appearance": DomainWorker(
        domain="appearance",
        label="身材样貌",
        expertise_prompt=(
            "【身材样貌专项断法】\n"
            "- 取象顺序：先定五行形相（日主五行 + 命局独旺之行；专旺/从格以旺神取形）→ 再看十神泄秀与用神是否有力 → 神煞只作加分项\n"
            "- 五行形相：木瘦长、火上尖下阔、土敦厚矮胖、金方正白净、水圆润肥满；燥土多结实、湿土多脂肪；兼形须按生克论（相生之兼为吉、相克之兼不和）\n"
            "- 十神泄秀：伤官泄秀主娇美灵动、食神泄秀主丰润亲和；泄秀太过反主清瘦，须先判喜忌与身之强弱\n"
            "- 特殊组合（甲逢庚克、丙逢壬制、土受木雕、金水相涵、木火通明）须**身旺有制**方论美；身弱而克泄交加者反不为美，不得见组合即断貌美\n"
            "- 高矮判断：木旺偏高、土旺偏矮、阳干横展、阴干细长，可给出区间范围\n"
            "- 胖瘦只论先天倾向：土多、印旺克食伤、食神运、水旺易丰润；枭神夺食、伤官旺、七杀无制易清瘦\n"
            "- 神煞加分：桃花/红艳主容貌有魅力，天乙贵人主形貌轩昂，六秀日主容貌端正，九丑日名丑而实有魅力\n"
            "- 古籍「多淫/轻佻」一类措辞属时代局限，一律中性转述为「外貌有魅力、异性缘旺、感情易有波折」，不得照搬\n"
            "- 形相歌诀（木瘦金方水主肥）属相法系统（相书《神相全编》系统），引用须注明来源为「传统形相歌诀」，不得冠以《渊海子平》《三命通会》等命理古籍篇名\n"
            "- 引用命理典籍只写「按《XX》形貌要义：……」，**不得**写「《XX·XX主题》云：……」（·XX主题 是知识库检索标签，非古籍篇名）\n"
            "- 合规提示：体重异常、内分泌、医美手术只给先天倾向与现实建议，不作医疗诊断，须提示以专业医师意见为准"
        ),
        extra_queries=("身材样貌 断法 五行 十神 桃花 体形",),
        length_rule="形貌类控制在2-4段≤500字；先给总体形貌倾向（以X形为主、带Y形特点），再说气质加分与高矮胖瘦倾向，最后一句现实建议。",
    ),
